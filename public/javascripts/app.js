...
//     e = e || window.event;
        ...
        if (IsAlphaNumeric(e)) {
            ...
            console.log(this.suggest_letter);
            if (index >= 0) {
        ...
        if (key == 8 || key == 46) {
            $(this.input_area).text(function(_, txt) {
                this.suggest_letter = this.suggest_letter + txt.slice(0, -1);
    ...
    Game.prototype.check = function() {
        ...
        var method = "POST";
        var checkData = {"match_string": $(this.input_area).text()}; //  {"name":"John Doe"}
        $.ajax({
            url: service_url,
            type: method,
            datatype: "json",
